<div>
    <div class="row mb-3">
        <div class="col-md-12 mb-0">
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="gingivits_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="gingivitis" wire:model="dentalHistory">
                        <label for="gingivits_checkbox">GINGIVITIS</label>
                    </div>                                            
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="recession_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="recession" wire:model="dentalHistory">
                        <label for="recession_checkbox">RECESSION</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="mobility_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="mobility" wire:model="dentalHistory">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="bone_loss_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="boneLoss" wire:model="dentalHistory">
                        <label for="bone_loss_checkbox">BONE LOSS</label>
                    </div>                                            
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="tmj_issues_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="tmjIssues" wire:model="dentalHistory">
                        <label for="tmj_issues_checkbox">TMJ ISSUES</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <input id="dental_history_none_checkbox" name="dentalHistory" class="me-2" type="checkbox" value="dentalHistoryNone" wire:model="dentalHistory">
                        <label for="dental_history_none_checkbox">NONE</label>
                    </div>
                </div>
            </div>
        </div>
        <div id="errorDentalHistory"></div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="row mb-3">
                <div class="col-md-12">
                    <label>Does the patient have any crowns/RCT treated teeth?<span class="text-danger"> *</span></label><br>
                    ...
                    <div id="errorDentalHistoryRCT"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <tr class="row border-bottom">
                            <td class="col-md-6 border-end p-1">
                                <table class="w-100">
                                    <tr>
                                        @for($i=8; $i>=1; $i--)
                                            <td><a href="javascript:void(0)" id="CRCT_TMQ2_MISSING_{{$i}}">{{$i}}</a></td>
                                        @endfor
                                    </tr>
                                    <tr>
                                        @for($i=8; $i>=1; $i--)
                            ...
                            <td class="col-md-6 p-1">
                                <table class="w-100">
                                    <tr>
                                        @for($i=1; $i<=8; $i++)
                                            <td><a title="Missing Teeth" href="javascript:void(0)" id="CRCT_TMQ1_MISSING_{{$i}}">{{$i}}</a></td>
                                        @endfor
                                    </tr>
                                    <tr>
                                        @for($i=1; $i<=8; $i++)
                        ...
                        <tr class="row">       
                            <td class="col-md-6 border-end p-1">
                                <table class="w-100">
                                    <tr>
                                        @for($i=8; $i>=1; $i--)
                                            <td><a href="javascript:void(0)" id="CRCT_TMQ3_MISSING_{{$i}}">{{$i}}</a></td>
                                        @endfor
                                    </tr>
                                    <tr>
                                        @for($i=8; $i>=1; $i--)     
                            ...
                            <td class="col-md-6 p-1">
                                <table class="w-100">
                                    <tr>
                                        @for($i=1; $i<=8; $i++)
                                            <td><a href="javascript:void(0)" id="CRCT_TMQ4_MISSING_{{$i}}">{{$i}}</a></td>
                                        @endfor
                                    </tr>
                                    <tr>
                                        @for($i=1; $i<=8; $i++)
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="row mb-3">
                <div class="col-md-12">
                    <label>Does the patient have any restorations/veneers?<span class="text-danger"> *</span></label>
                    <div class="form-group d-flex">
                        <div class="form-group d-flex align-items-baseline me-2">
                    ...
                    <div id="errorDentalHistoryRestoration"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <tr class="row">    
                                <td class="col-md-6 border-end p-1">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=8; $i>=1; $i--)
                                                <td><a href="javascript:void(0)" id="RV_TMQ3_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=8; $i>=1; $i--)
                                ...
                                <td class="col-md-6 p-1">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
                                                <td><a href="javascript:void(0)" id="RV_TMQ4_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="row mb-3">
                <div class="col-md-12">
                    <label>Does the patient have any bridges/implants?<span class="text-danger"> *</span></label>
                    <div class="form-group d-flex">
                        <div class="form-group d-flex align-items-baseline me-2">
                ...
                <div id="errorDentalHistoryImplants"></div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                            ...
                            <tr class="row border-bottom">
                                <td class="col-md-6 border-end p-1">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=8; $i>=1; $i--)
                                                <td><a href="javascript:void(0)" id="BI_TMQ2_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=8; $i>=1; $i--)
                                ...
                                <td class="col-md-6 p-1">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
                                            <td><a title="Missing Teeth" href="javascript:void(0)" id="BI_TMQ1_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
                            ...
                            <tr class="row">       
                                <td class="col-md-6 border-end p-1">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=8; $i>=1; $i--)
                                            <td><a href="javascript:void(0)" id="BI_TMQ3_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=8; $i>=1; $i--)       
                                ...
                                <td class="col-md-6">
                                    <table class="w-100">
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
                                                <td><a href="javascript:void(0)" id="BI_TMQ4_MISSING_{{$i}}">{{$i}}</a></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for($i=1; $i<=8; $i++)
