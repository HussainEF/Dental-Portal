<div>
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="row mb-1">
                <div class="col-md-12">
                    <label class="" for="">SPACE CLOSURE<span class="text-danger"> *</span></label>
                </div>
            </div>
            <div class="row mb-1">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input id="sc_upper_complete_checkbox" name="space_closure" class="me-2" value="scUpperComplete" type="checkbox" wire:model="spaceClosure">
                            <label for="sc_upper_complete_checkbox">Complete</label>
                        </div>
                        <div class="col-md-4">
                            <input id="sc_upper_leave_checkbox" name="space_closure" class="me-2" value="scUpperLeave" type="checkbox" wire:model="spaceClosure">
            ...
            <div class="row mb-1">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input id="sc_lower_complete_checkbox" name="space_closure" class="me-2" value="scLowerComplete" type="checkbox" wire:model="spaceClosure">
                            <label for="sc_lower_complete_checkbox">Complete</label>
                        </div>
                        <div class="col-md-4">
                            <input id="sc_lower_leave_checkbox" name="space_closure" class="me-2" value="scLowerLeave" type="checkbox" wire:model="spaceClosure">
        ...
        <div id="errorSpaceClosure"></div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
            <label class="" for="">CROWDING RESOLUTION<span class="text-danger"> *</span></label>
            <div class="row mt-1 mb-1">
                <div class="col-md-3">
                    <input id="cr_ipr_checkbox" name="crowding_resolution" class="me-2" value="crIPR" type="checkbox" wire:model="crowdingResolution">
                    <label for="cr_ipr_checkbox">IPR</label>
                </div>
                <div class="col-md-3">
                    <input id="cr_proclination_checkbox" name="crowding_resolution" class="me-2" value="crProclination"  type="checkbox" wire:model="crowdingResolution">
                    <label for="cr_proclination_checkbox">Proclination</label>
                </div>
                <div class="col-md-3">
                    <input id="cr_expansion_checkbox" name="crowding_resolution" class="me-2" value="crExpansion" type="checkbox" wire:model="crowdingResolution">
                    <label for="cr_expansion_checkbox">Expansion</label>
                </div>
                <div class="col-md-3">
                    <input id="cr_extraction_checkbox" name="crowding_resolution" class="me-2" value="crExtraction"  type="checkbox" wire:model="crowdingResolution">
        ...
        <div id="errorCrowdingResolution"></div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="row mb-2">
                ...
                <div class="col-md-3">
                    <input id="midline_maintain_checkbox" name="midline_2" class="me-2" value="midlineMaintain" type="checkbox" wire:model="midlineMaintainCorrect">
                    <label for="midline_maintain_checkbox">Maintain</label>
                </div>
                <div class="col-md-3">
                    <input id="midline_correct_checkbox" name="midline_2" class="me-2" value="midlineCorrect" type="checkbox" wire:model="midlineMaintainCorrect">
                    <label for="midline_correct_checkbox">Correct</label>
                </div>
                <div id="errorMidline2"></div>
            </div>
            <div class="row mt-3">
                <div class="col-md-6">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <label class="" for="">PERMANENT CANINE OCCLUSION GOAL<span class="text-danger"> *</span></label>
            <div class="row mt-1">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <label class="" for="">PERMANENT Molar Occlusion Goal</span></label>
            <div class="row mt-1">
                <div class="col-md-4 d-flex align-items-baseline">
                    <label class="" for="">Class |</label>
                    <div class="form-group d-flex align-items-baseline ms-4 me-4">
