<form action="" wire:submit="caseSave" class="case-form">
    ...
    {{-- STEP 1 --}}
    @if($currentStep === 1)
    <livewire:case-add.components.step1.step1 wire:key="step1" :currentStep="$currentStep" :step1Data="$step1Data"/>
    @endif

    {{-- STEP 2 --}}
    @if($currentStep === 2)
    <livewire:case-add.components.step2.step2 wire:key="step2" :currentStep="$currentStep" :step2Data="$step2Data"/>
    @endif

    {{-- STEP 3 --}}
    @if($currentStep === 3)
    <livewire:case-add.components.step3.step3 wire:key="step3" :currentStep="$currentStep" :step3Data="$step3Data"/>
    @endif

    {{-- STEP 4 --}}
    @if($currentStep === 4)
    <livewire:case-add.components.step4.step4 wire:key="step4" :currentStep="$currentStep" :step4Data="$step4Data"/>
    @endif

    {{-- STEP 5 --}}
    @if($currentStep === 5)
    <livewire:case-add.components.step5.step5 wire:key="step5" :currentStep="$currentStep" :step5Data="$step5Data"/>
    @endif

    {{-- STEP 6 --}}
    @if($currentStep === 6)
    <livewire:case-add.components.step6.step6 wire:key="step6" :currentStep="$currentStep" :step6Data="$step6Data"/>
    @endif

    {{-- STEP 7 --}}
    @if($currentStep === 7)
    <livewire:case-add.components.step7.step7 wire:key="step7" :currentStep="$currentStep" :step7Data="$step7Data"/>
    @endif
