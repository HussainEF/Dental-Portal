...
<div>
    <fieldset class="wizard-fieldset {{$currentStep != 1 ? 'd-none':'show'}}">
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="wfirstName2"> Patient Name : <span class="text-danger"> *</span>
                    </label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                <label for="wlastName2"> Patient Age : <span class="text-danger"> *</span>
                </label>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="emailAddress" class="">Email: <span class="text-danger"> *</span></label>
