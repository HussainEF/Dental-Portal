...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .doctor_signature {
                font-family: 'Southam Demo', sans-serif !important; 
                font-size: 14pt;
            }
    ...
    <body>
        <div class="row">
            <h2 class="heading">Doctor Consent Form</h2>
        </div>
        <div class="row">
            <table>
                <tr>
        ...
        <p class="left"><span class="sign_lable">Signature:</span>  <span class="doctor_signature">{{$data['sign']}}</span></p>
    </body>
</html>
