<div>
    ...
    <div class="row">
      <h2 class="underline" style="font-family: sans-serif;">Doctor Consent Form</h2>
    </div>
    <div class="row">
    ...
    <p class="left">Signature:  <span style="font-family: 'Southam Demo', sans-serif; font-weight:bold; font-size:15px;"></p>
</div>
